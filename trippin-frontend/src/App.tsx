...
import { MapPin, Calendar, DollarSign, Plane, Building2, UtensilsCrossed, Mountain, PartyPopper, Loader2 } from 'lucide-react'
...
function App() {
  ...
  const getCategoryColor = (categoryName: string) => {
    if (categoryName.includes('Historical')) return 'bg-blue-100 text-blue-800 border-blue-200'
    if (categoryName.includes('Food')) return 'bg-orange-100 text-orange-800 border-orange-200'
    if (categoryName.includes('Scenic')) return 'bg-green-100 text-green-800 border-green-200'
    if (categoryName.includes('Partying')) return 'bg-purple-100 text-purple-800 border-purple-200'
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Trippin</h1>
          </div>
          <p className="text-lg text-gray-600">Plan your perfect trip with personalized itineraries</p>
        </div>
